#' A function to retrieve the predsxobs distance matrices from a SpatialStreamNetwork object, arranged in numeric order
#' 
#' @param x An object of class SpatialStreamNetwork
